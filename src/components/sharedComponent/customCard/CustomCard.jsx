...
const CustomCard = ({ src, title, header }) => {
  return (
    <div className="group flex flex-col justify-center items-center rounded-lg w-[282px] h-[270px] shadow-lg bg-[#F9F9F9] hover:bg-gradient-to-b from-[#DDB762] to-[#887857] transition duration-300">
    <div className="flex flex-col justify-center items-center">
      ...
      <h1 className="group-hover:text-white">{header}</h1>
